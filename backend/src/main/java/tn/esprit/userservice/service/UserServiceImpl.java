...
public class UserServiceImpl implements IUserService {
    ...
    @Override
    public java.util.List<PublicUserDTO> searchUsersByEmailExcludingAgency(String email, Long agencyId) {
        return userRepository.findAvailableFreelancersForAgencyFiltered(agencyId, Role.FREELANCER, null, email)
                .stream().map(u -> PublicUserDTO.builder()
                        .id(u.getId())
