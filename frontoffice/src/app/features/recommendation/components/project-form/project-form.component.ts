...
export class ProjectFormComponent implements OnInit {
  ...
  nextStep(): void {
    if (this.currentStep === 0 && this.descriptionForm.valid) this.currentStep = 1;
    else if (this.currentStep === 1 && this.budgetForm.valid) this.currentStep = 2;
  }
  ...
  setStep(index: number): void {
    if (index === 0) this.currentStep = 0;
    if (index === 1 && this.descriptionForm.valid) this.currentStep = 1;
    if (index === 2 && this.descriptionForm.valid && this.budgetForm.valid) this.currentStep = 2;
  }
