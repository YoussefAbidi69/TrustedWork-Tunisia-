...
export class NavbarComponent implements OnInit {
  ...
  navItems: NavItem[] = [
    ...
    },
    {
      ...
      children: [
        { label: 'Communities', route: '/community', description: 'Communities and discussions' },
        { label: 'Contributions', route: '/community/contributions', description: 'Contribute with active members'  }
      ]
    }
  ];
