...
export class SidebarComponent implements OnInit {
  ...
  navGroups: NavGroup[] = [
    ...
    },
    {
      ...
      expanded: false,
      children: [
        { label: 'Market Insights', icon: 'fa-chart-pie', route: '/app/job-board/market-insights' },
        { label: 'Marketplace', icon: 'fa-briefcase', route: '/app/job-board/marketplace' },
        { label: 'Mes Candidatures', icon: 'fa-file-lines', route: '/app/job-board/my-applications' },
        { label: 'Recommandations AI', icon: 'fa-robot', route: '/app/job-board/recommendations' },
        { label: 'Career Insights', icon: 'fa-compass', route: '/app/job-board/career-insights' },
        { label: 'Publier un Emploi', icon: 'fa-plus', route: '/app/job-board/post-job' },
        { label: 'Mes Offres', icon: 'fa-folder-open', route: '/app/job-board/my-jobs' },
        { label: 'Messages', icon: 'fa-envelope', route: '/app/job-board/messages' }
      ]
    }
  ];
  ...
  private resolvePhotoUrl(photo: string): string {
    ...
    return `http://localhost:8081/api${photo}`;
  }
