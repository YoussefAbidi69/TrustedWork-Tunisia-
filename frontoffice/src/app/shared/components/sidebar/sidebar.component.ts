...
export class SidebarComponent implements OnInit {
  ...
  // ── Module 06 — Engagement (actifs) ─────────────────
  engagementItems: NavItem[] = [
    { label: 'Événements',   icon: 'fa-calendar-days', route: '/app/engagement/events' },
    { label: 'Missions',     icon: 'fa-rocket',        route: '/app/engagement/missions' },
    { label: 'Gamification', icon: 'fa-trophy',        route: '/app/engagement/gamification' },
    { label: 'Classement',   icon: 'fa-ranking-star',  route: '/app/engagement/leaderboard' }
  ];
