...
export class SidebarComponent implements OnInit {
  ...
  businessItems: NavItem[] = [
    ...
    { label: 'Transactions',   icon: 'fa-arrow-right-arrow-left', route: '/app/finance/transactions' },
    { label: 'Escrow',         icon: 'fa-lock',          route: '/app/finance/escrow' },
    { label: 'Historique Paiement', icon: 'fa-receipt', route: '/app/finance/payments-history' }
  ];
